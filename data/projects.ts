...
export const projects: Project[] = [
  {
    id: 'empleo-juvenil-canarias',
    title: 'Análisis Inteligente del Empleo',
    category: 'Data Engineering & Science',
    description: 'Análisis del empleo juvenil basado en la metodología CRISP-DM: del microdato al dashboard interactivo.',
    longDescription: 'Proyecto de Ciencia de Datos calificado con un 9/10. Realicé un proceso riguroso de limpieza y preparación de microdatos (ETL manual) provenientes de Eurostat e ISTAC siguiendo la metodología CRISP-DM. El trabajo incluye un análisis exploratorio profundo, una memoria técnica detallada y un dashboard interactivo en R Shiny con modelos ARIMA para la predicción de tendencias.',
    challenges: [
      'Implementación del estándar industrial CRISP-DM para minería de datos.',
      'Tratamiento y limpieza de microdatos oficiales complejos.',
      'Creación de visualizaciones interactivas y modelos predictivos en R.'
    ],
    metrics: [
      'Calificación Académica: 9/10.',
      'Pipeline de datos 100% automatizado en R.',
      'Análisis comparativo de +20 regiones europeas.'
    ],
    techStack: ['R', 'Shiny', 'ARIMA Models', 'Leaflet', 'ISTAC API'],
    tags: ['Data Science', 'Engineering', 'Canarias', 'GitHub'],
    imageUrl: '/dashboard-empleo.png',
    projectType: 'real',
    link: 'https://github.com/yonillo/youth-employment-analysis-europe'
  },
  {
    id: 'agaete-live',
    title: 'Agaete.live',
