                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  {project.link ? (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-12 h-12 rounded-2xl bg-stone-100 flex items-center justify-center text-stone-400 hover:bg-mar-900 hover:text-white transition-all duration-500"
                    >
