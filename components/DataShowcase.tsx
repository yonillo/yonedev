        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-white mb-6">
              Inteligencia de Datos para la <br />
              <span className="text-mar-400 italic">eficiencia operativa.</span>
            </h2>
            <p className="text-stone-400 text-lg mb-8 leading-relaxed">
              No solo capturo datos; diseño el cerebro analítico que optimiza tu negocio. Implemento sistemas de monitorización y predicción para reducir costes, mejorar procesos y tomar decisiones basadas en evidencias, no en intuiciones.
            </p>
            
            <ul className="space-y-4">
              {[
                "Análisis de costes y optimización de recursos",
                "Modelado predictivo de demanda y tendencias",
                "Dashboards de eficiencia operativa en tiempo real",
                "Automatización de reportes de KPIs críticos"
              ].map((item, i) => (
