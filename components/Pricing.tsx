...
export const Pricing: React.FC = () => {
  const plans = [
    {
      name: "Mantenimiento & Seguridad",
      price: "29",
      isStarting: true,
      desc: "Ideal para webs que solo necesitan estar online, seguras y siempre actualizadas.",
      features: ["Alojamiento y Dominio", "Seguridad SSL & Backup", "Optimización de Velocidad", "Soporte Técnico"],
      icon: ShieldCheck,
      featured: false
    },
    {
      name: "Crecimiento & Automatización",
      price: "69",
      isStarting: true,
      desc: "Para negocios que quieren vender más y automatizar su atención al cliente.",
      features: ["Todo lo de Mantenimiento", "Chatbots con IA (Gemini)", "SEO & Visibilidad", "Soporte WhatsApp Prioritario"],
      icon: HeartPulse,
      featured: true
    },
    {
      ...
      price: "Consúltame",
      isStarting: false,
      desc: "Sistemas complejos, dashboards de negocio y sincronización de stock.",
      features: ["Dashboards BI a medida", "Sincronización de Inventario", "Data Scraping Competencia", "Consultoría Estratégica"],
      icon: Settings2,
      featured: false
    }
  ];
  ...
  return (
    <section id="pricing" className="py-24 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-white rounded-[2rem] border border-dashed border-stone-300 text-center max-w-3xl mx-auto flex flex-col items-center gap-6">
          ...
          <a 
            href="/servicios" 
            className="inline-flex items-center gap-2 text-mar-700 font-bold uppercase tracking-widest text-xs hover:text-mar-900 transition-colors"
          >
            Ver detalle de todos los servicios <ArrowRight size={16} />
          </a>
        </div>
      </div>
    </section>
