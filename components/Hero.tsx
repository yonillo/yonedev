          ...
          >
            ...
            <p className="text-xl md:text-2xl text-stone-500 mb-8 max-w-2xl leading-relaxed font-medium">
              Soy Yone. <span className="relative inline-block text-stone-900 font-bold">
                Digitalizo negocios canarios con ingeniería.
                <span className="absolute bottom-1 left-0 w-full h-1.5 bg-emerald-500/20 rounded-full -z-10"></span>
              </span> Menos tareas repetitivas, más decisiones basadas en datos. Desarrollo ecosistemas digitales diseñados para <span className="text-transparent bg-clip-text bg-gradient-to-r from-mar-700 to-mar-500 font-bold italic">vender más</span> y operar mejor desde Canarias.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a 
                href="https://github.com/yonillo" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-8 py-4 bg-white border border-stone-200 rounded-2xl font-bold text-stone-700 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
              >
                <Github size={20} className="group-hover:text-mar-600 transition-colors" />
                Explorar GitHub
              </a>
            </div>
          </motion.div>
