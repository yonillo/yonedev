        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-8 text-stone-500 text-lg leading-relaxed font-medium">
              <p>
                Soy estudiante de <span className="text-stone-900 font-bold">Ciencia e Ingeniería de Datos en la ULPGC</span>, especializado en transformar flujos de información en decisiones estratégicas. Mi enfoque une el rigor de la metodología <span className="text-stone-900 font-bold">CRISP-DM</span> con la agilidad del desarrollo web moderno.
              </p>
              <p className="border-l-4 border-mar-200 pl-6 italic text-stone-600">
                No solo construyo plataformas; diseño arquitecturas que optimizan procesos y extraen valor de los datos. Mi experiencia analizando microdatos oficiales demuestra mi capacidad para convertir la complejidad en dashboards accionables para el negocio.
              </p>
              <p>
                Desde Gran Canaria y Tenerife, desarrollo soluciones escalables que conectan el talento y los negocios de las islas con el mercado global, siempre bajo una visión de ingeniería orientada a resultados y eficiencia técnica.
              </p>
            </div>
